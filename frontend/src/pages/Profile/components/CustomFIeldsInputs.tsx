    ...
    <div className="grid grid-cols-1 gap-x-3 gap-y-6 md:gap-y-8 md:grid-cols-2">
      {Array.from(props.fields).map(field => {
        ...
        switch (field.html_type) {
          case "Text":
            return <TextField className="flex justify-center" label={field.label} id={id} disabled={props.disabled} handleFields={props.handleFields} required={field.is_required} />
          case "Radio":
